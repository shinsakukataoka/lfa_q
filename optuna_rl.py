...
if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        n_patients_suggest = trial.suggest_int('n_patients', 50, 150)
        n_actions_suggest = trial.suggest_int('n_actions', 2, 4)
        
        # Override Flags values
        Flags.n_patients = n_patients_suggest
        Flags.n_actions = n_actions_suggest

        tf1.app.run(main=main)

        return best_reward_global
